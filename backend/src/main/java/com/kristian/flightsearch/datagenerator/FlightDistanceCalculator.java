...
public class FlightDistanceCalculator {
    ...
    public static void main(String[] args) {
        double distance = 0.0;
        Airport JFK = new Airport("JFK", "John F. Kennedy International Airport", 40.641766, -73.780968, 4423, 13, "New York", "United States");
        Airport DEN = new Airport("DEN", "Denver International Airport", 39.849312, -104.673828, 4877, 1655, "Denver", "United States");
